...
@WebServlet(name = "adminWorkOrderUpdateServiceServlet", value = "/admin/work-orders/update-service")
public class AdminWorkOrderUpdateServiceServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            workOrderService.updateServiceLineQuantityOnWorkOrder(workOrderId, lineId, qty);
            request.getSession().setAttribute("adminWorkOrderFlashMessage", "Service quantity updated.");
