...
@WebServlet(name = "adminWorkOrderAddPartServlet", value = "/admin/work-orders/add-part")
public class AdminWorkOrderAddPartServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            workOrderService.addPartLineToWorkOrder(workOrderId, partId, qty);
            request.getSession().setAttribute("adminWorkOrderFlashMessage", "Part line added.");
