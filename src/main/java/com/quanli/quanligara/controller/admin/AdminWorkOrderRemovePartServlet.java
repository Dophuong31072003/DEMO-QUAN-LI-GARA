...
@WebServlet(name = "adminWorkOrderRemovePartServlet", value = "/admin/work-orders/remove-part")
public class AdminWorkOrderRemovePartServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            workOrderService.removePartLineFromWorkOrder(workOrderId, lineId);
            request.getSession().setAttribute("adminWorkOrderFlashMessage", "Part line removed.");
